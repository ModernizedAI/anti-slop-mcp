...
@app.post("/format_python")
async def format_python(request: ContentRequest):
    ...
    try:
        ...
        try:
            ...
            formatted = black.format_str(request.content, mode=mode)
            ...
            # Fallback: basic indentation fixes
            ...
            for line in lines:
                if line.strip():
                    ...
                    formatted_lines.append(' ' * proper_indent + stripped)
                else:
            ...
            return {
                "original_content": request.content,
                "formatted_content": formatted,
                "changes_made": "Basic indentation fixes applied (4-space indent)",
                "formatter": "basic"
            }
    except Exception as e:
        raise HTTPException(status_code=500, detail=f"Failed to format Python code: {str(e)}")
